...
INSERT INTO proveedor (nombre, telefono, ruc, direccion, indicador) 
VALUES ('CROSLAND', '123456789', '1234567890', 'Jr. Ejemplo', 'V');
...
VALUES
    ('REP001', 'Marca1', 'Repuesto1', 10.50, 15.99, 50, 'S'),
    ('REP002', 'Marca2', 'Repuesto2', 8.25, 12.99, 30, 'S'),
    ('REP003', 'Marca3', 'Repuesto3', 12.75, 19.99, 20, 'S'),
    ('REP004', 'Marca1', 'Repuesto4', 9.99, 14.99, 40, 'S'),
    ('REP005', 'Marca2', 'Repuesto5', 7.50, 11.99, 60, 'S'),
    ('REP006', 'Marca3', 'Repuesto6', 11.25, 16.99, 25, 'S'),
    ('REP007', 'Marca1', 'Repuesto7', 13.50, 20.99, 35, 'S'),
    ('REP008', 'Marca2', 'Repuesto8', 10.75, 17.99, 45, 'S'),
    ('REP009', 'Marca3', 'Repuesto9', 9.25, 13.99, 55, 'S'),
    ('REP010', 'Marca1', 'Repuesto10', 8.99, 12.99, 50, 'S');
